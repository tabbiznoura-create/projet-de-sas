 ...
 *
 * 🎯 MISSION
 * Créez une fonction possedePropriete(obj, cle) qui retourne true si la clé existe dans l'objet, sinon false. *(Indice : vous pouvez 
 * utiliser l'opérateur in ou vérifier si c'est !== undefined)*.
 *
