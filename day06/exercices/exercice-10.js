 ...
 *
 * 🎯 MISSION
 * Vous avez une chaîne de caractères "abracadabra". 
 * Créez une fonction qui retourne un objet comptant le nombre d'occurrences 
 * de chaque lettre. (ex: { a: 5, b: 2, r: 2, c: 1, d: 1 }).
 *
