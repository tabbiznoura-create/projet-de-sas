...
**Ma réponse :**
Quand le nom de la propriété est stocké dans une variable nous utilise les crochets et dans l'appelle de la propriete nous n'utilise pas,
...
**Ma réponse :**
il returne undefined ex. let personne = {nom: ali , age: 21}, console.log(email)
> À compléter avec mes propres mots.
...
**Ma réponse :**
objet.ville = "casa" il ajout casa a un nouveau objet.
> À compléter avec mes propres mots.
...
**Ma réponse :**
delete objet.ville, il suppreme son ville dans un objet,
> À compléter avec mes propres mots.
...
**Ma réponse :**
for ...in pour parcourir un clés d'un objet, mais for...of il utilise pour les stri,g et les tableau,
À compléter avec mes propres mots.
...
**Ma réponse :**
console.log(this.nom + "a" + this.age + "ans"), this fait référence à l'objet qui appelle la méthode,
> À compléter avec mes propres mots.
...
**Ma réponse :**
JSON est une string utilisé pour échanger des données entre serveur et navigateur par ex. Ce n'est pas un objet JS réel, juste du texte qui en a la forme
> À compléter avec mes propres mots.
...
**Ma réponse :**
quand obj1 et obj2 vont pointer vers le même objet en mémoire
si nous modifies obj2 obj1 aussi va modifier, car il existe une seule copie réelle de l’objet
> À compléter avec mes propres mots.
